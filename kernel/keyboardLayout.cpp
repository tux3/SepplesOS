unsigned char kbdmap[] = {
    0x1B, 0x1B, 0x1B, 0x1B,	/*   esc (0x01) */		        	/// 0
    '1', '!', '1', '1',
    '2', '@', '2', '2',
    '3', '#', '3', '3',
    '4', '$', '4', '4',
    ...
    '7', 0xFF, 0xFF, 0xFF,	/*NUMPAD(0x47)  */					/// 70
    '8', 0xFF, 0xFF, 0xFF,	/*NUMPAD(0x48)  */
    '9', 0xFF, 0xFF, 0xFF,	/*NUMPAD(0x49)  */
    '-', 0xFF, 0xFF, 0xFF,	/*NUMPAD(0x4a)  */
    '4', 0xFF, 0xFF, 0xFF,	/*NUMPAD(0x4b)  */
    '5', 0xFF, 0xFF, 0xFF,	/*NUMPAD(0x4c)  */
    '6', 0xFF, 0xFF, 0xFF,	/*NUMPAD(0x4d)  */
    '+', 0xFF, 0xFF, 0xFF,	/*NUMPAD(0x4e)  */
    '1', 0xFF, 0xFF, 0xFF,	/*NUMPAD(0x4f)  */
    '2', 0xFF, 0xFF, 0xFF,	/*NUMPAD(0x50)  */
    '3', 0xFF, 0xFF, 0xFF,	/*NUMPAD(0x51)  */					/// 80
    '0', 0xFF, 0xFF, 0xFF,	/*NUMPAD(0x52)  */
    '.', 0xFF, 0xFF, 0xFF,	/*NUMPAD(0x53)  */
